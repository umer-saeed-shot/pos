...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::put('tax/change', 'TaxController@updateUserTax')->name('tax.change');
	...
	//Route::post('customer/updatecuspos', 'CustomerController@updatecuspos');
	Route::post('customer/updatecuspos', 'CustomerController@updatecuspos');
	Route::resource('/updatecuspos', 'CustomerController');
	...
	Route::post('sales/sale-datahold', 'SaleController@saleDataHold');
	Route::get('sales/sale-hold', 'SaleController@indexHold');
	...
	Route::post('sales/delete_misc_products','SaleController@deleteMiscProducts')->name('delete.misc.items');
	Route::post('importsale', 'SaleController@importSale')->name('sale.import');
	Route::get('pos/{draft_id?}', 'SaleController@posSale')->name('sale.pos');
	Route::get('unhold_pos/{id}', 'SaleController@unholdPosSale')->name('sale.unholdpos');
	...
	Route::get('sales/getheldproduct/{id}', 'SaleController@getHeldProducts')->name('sale.getheldproducts');
	...
	Route::post('sales/add_paymentt', 'SaleController@addPaymentt')->name('sale.add-paymentt');
	...
	Route::put('setting/general_setting_store', 'SettingController@generalSettingStore');
	...
	Route::get('setting/email-messages', 'SettingController@emailMessages')->name('setting.email-messages');
	Route::get('setting/email-messages/delete/{id}', 'SettingController@deleteEmailMessage')->name('email-message.delete');
	Route::post('setting/email-messages', 'SettingController@storeEmailMessages')->name('setting.email-messages');
