    ...
    public function purchaseData(Request $request)
    {
        ...
        if(!empty($purchases))
        {
            foreach ($purchases as $key=>$purchase)
            {
                ...
                $nestedData['store'] = $purchase->warehouse->name;
    ...
    public function create()
    {
      ...
      // echo '<pre>'; print_r(  $role); exit;
        if($role->hasPermissionTo('purchases-add')){
            ...
            $lims_warehouse_list = Warehouse::select('warehouses.*')->leftJoin('users', 'users.warehouse_id', '=', 'warehouses.id')->where([['warehouses.is_active', true],['users.id',Auth::id()]])->get();
...
//echo '<pre>'; print_r($lims_product_list_with_variant); exit;
    ...
    public function store(Request $request)
    {
        ...
        foreach ($product_id as $i => $id) {
           ...
           // echo '<pre>'; print_r($lims_product_warehouse_data); exit;
        ...
        if($role->hasPermissionTo('purchases-delete')){
            ...
            foreach ($lims_product_purchase_data as $product_purchase_data) {
                ...
                if($product_purchase_data->variant_id) {
                    ...
                    // dd($product_purchase_data->product_id, $lims_purchase_data->warehouse_id);
                    $lims_product_warehouse_data = Product_Warehouse::FindProductWithoutVariant($product_purchase_data->product_id, $lims_purchase_data->warehouse_id)
                        ->first();
                }
