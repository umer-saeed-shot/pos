...
class ReportController extends Controller
{
    ...
    public function saleReport(Request $request)
    {
        ...
        $product_category = [];
        $product_qty = [];
        $lims_product_all = Product::select('id', 'name', 'qty', 'is_variant','category_id')->where('is_active', true)->get();
        ...
        $lims_warehouse_list = Warehouse::where('is_active', true)->get();
        return view('report.sale_report',compact('product_id', 'variant_id', 'product_name','product_category', 'product_qty', 'start_date', 'end_date', 'lims_warehouse_list','warehouse_id'));
    }
