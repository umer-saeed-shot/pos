...
/////////////////////////////////////////////////////////////
    ...
    public function getHeldProducts($id){
        ...
        foreach($product_sale as $pro){
            ...
            $temp_product[] = $pro->unit_price;


            if($pro->tax_id) {
                $temp_product[] = $pro->tax_rate;
                $tax_data = Tax::find($pro->tax_id);
                $temp_product[] = $tax_data->name;
            ...
            $temp_product[] = $product_warehouse->qty;
            $temp_product[] = $pro->qty;
