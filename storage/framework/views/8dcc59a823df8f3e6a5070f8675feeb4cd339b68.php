                            ...
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('file.Net Unit Price')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('file.Order Discount')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('file.Coupon Discount')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                                            </label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/sale/edit.blade.php ENDPATH**/ ?>