...
<script type="text/javascript">
    ...
    $("#submit-button").on("click", function(event) {
        ...
        if(paper_size != "0") {
			...
			//<table class="barcodelist" style="width:378px;" cellpadding="5px" cellspacing="10px">
            var htmltext = '<table class="barcodelist" style="width:100%; height:100%;" cellpadding="5px" cellspacing="10px">';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/editingteam/public_html/pos/resources/views/product/print_barcode.blade.php ENDPATH**/ ?>