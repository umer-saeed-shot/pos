                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.Order Tax')); ?> (<?php echo e(auth()->user()->currency); ?>)</label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/purchase/edit.blade.php ENDPATH**/ ?>