                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_le_sph')); ?> </label>
                            <input type="text" name="dv_le_sph"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_le_cyl')); ?> </label>
                            <input type="text" name="dv_le_cyl"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_le_axis')); ?> </label>
                            <input type="text" name="dv_le_axis"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_re_sph')); ?> </label>
                            <input type="text" name="dv_re_sph"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_re_cyl')); ?> </label>
                            <input type="text" name="dv_re_cyl"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.dv_re_axis')); ?> </label>
                            <input type="text" name="dv_re_axis"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_le_sph')); ?> </label>
                            <input type="text" name="nv_le_sph"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_le_cyl')); ?> </label>
                            <input type="text" name="nv_le_cyl"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_le_axis')); ?> </label>
                            <input type="text" name="nv_le_axis"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_re_sph')); ?> </label>
                            <input type="text" name="nv_re_sph"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_re_cyl')); ?> </label>
                            <input type="text" name="nv_re_cyl"  class="form-control">
                        </div>
                        <div class="form-group">
                            <label><?php echo e(trans('file.nv_re_axis')); ?> </label>
                            <input type="text" name="nv_re_axis"  class="form-control">
                        </div>
                        <div class="form-group">
                        <input type="hidden" name="pos" value="1">      
...
function addNewProduct(data){
    ...
    cols += '<td class="col-sm-4 product-title"><button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"><strong>' + data[0] + '</strong></button> [' + data[1] + '] <p>In Stock: <span><input type="text" name="dupprice" class="dupprice" style="width:35px; border:none;" onkeyup="call(\''+a+'\',\''+rowCount+'\')"></span><span class="in-stock"></span></p></td>';
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/editingteam/public_html/POS/resources/views/sale/pos.blade.php ENDPATH**/ ?>