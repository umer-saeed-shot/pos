					...
					<table class="table table-bordered" style="border-top: 1px solid #dee2e6; border-bottom: 1px solid #dee2e6;">
					    ...
					    <tbody>
						    ...
						    <tr>
						        ...
						        <td>
						        	<?php if($discount > 0): ?>
							      	<strong><?php echo e(trans("file.Product Discount")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
							      	<span><?php echo e($discount); ?></span><br><br>
							      	<?php endif; ?>
							      	<?php if($order_discount[$key] > 0): ?>
							      	<strong><?php echo e(trans("file.Order Discount")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
							      	<span><?php echo e($order_discount[$key]); ?></span><br><br>
							      	<?php endif; ?>
							      	<?php if($total_tax[$key] > 0): ?>
							      	<strong><?php echo e(trans("file.Product Tax")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
							      	<span><?php echo e($total_tax[$key]); ?></span><br><br>
							      	<?php endif; ?>
							      	<?php if($order_tax[$key] > 0): ?>
							      	<strong><?php echo e(trans("file.Order Tax")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
							      	<span><?php echo e($order_tax[$key]); ?></span><br><br>
							      	<?php endif; ?>
							      	<?php if($shipping_cost[$key] > 0): ?>
							      	<strong><?php echo e(trans("file.Shipping Cost")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
							      	<span><?php echo e($shipping_cost[$key]); ?></span><br><br>
							      	<?php endif; ?>
							      	<?php if($grand_total[$key] > 0): ?>
							      	<strong><?php echo e(trans("file.grand total")); ?> (<?php echo e(auth()->user()->currency); ?>)</strong><br>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/report/monthly_purchase.blade.php ENDPATH**/ ?>