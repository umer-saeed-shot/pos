                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('Purchasing Price')); ?> (<i style="color:#cf2029" class="fa fa-usd" aria-hidden="true"></i>) *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Selling Price')); ?> (<i style="color:#cf2029" class="fa fa-usd" aria-hidden="true"></i>) *</strong> </label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/editingteam/public_html/pos/resources/views/product/create.blade.php ENDPATH**/ ?>