                        ...
                        <?php echo Form::open(['route' => 'user.store', 'method' => 'post', 'files' => true]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="currencyId">
                                        <label><strong>Currency *</strong></label>
                                        <select name="currency" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Default Currency...">
                                          <?php $__currentLoopData = $lims_currency_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($currency->code); ?>"><?php echo e($currency->name); ?> - <?php echo e($currency->code); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="form-group" id="taxID">
                                        <label><strong>Tax *</strong></label>
                                        <select name="tax_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Default Tax...">
...
<script type="text/javascript">
    ...
    $('select[name="role_id"]').on('change', function() {
        if($(this).val() == 5) {
            ...
            $('select[name="currency_id"]').prop('required',false);
            $('select[name="biller_id"]').prop('required',false);
        }
        else if($(this).val() >= 1 && $(this).val() != 5) {
            $('select[name="warehouse_id"]').prop('required',true);
            $('select[name="currency_id"]').prop('required',true);
            $('select[name="biller_id"]').prop('required',false);
            //$('#biller-id').show(300);
