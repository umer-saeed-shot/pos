        ...
        <table id="report-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th>Category Name</th>
                    <th><?php echo e(trans('file.Sold Amount')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($product_category[$key]); ?></td>
                    <?php
                        if($warehouse_id == 0){
                            if($variant_id[$key]) {
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/report/sale_report.blade.php ENDPATH**/ ?>