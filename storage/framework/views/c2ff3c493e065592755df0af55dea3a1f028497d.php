...
<script type="text/javascript">
    ...
    if($('select[name=role_id]').val() > 1 && $('select[name=role_id]').val() !=5){
        $('#warehouseId').show();
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/editingteam/public_html/pos/resources/views/user/edit.blade.php ENDPATH**/ ?>