...
<section class="forms">
                            ...
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(trans('file.Net Unit Cost')); ?>(<?php echo e(auth()->user()->currency); ?>)</th>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('file.Discount')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(trans('file.Shipping Cost')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                                            </label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td><strong><?php echo e(trans('file.Total')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Order Tax')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Order Discount')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                <span class="pull-right" id="order_discount">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.Shipping Cost')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
                <span class="pull-right" id="shipping_cost">0.00</span>
            </td>
            <td><strong><?php echo e(trans('file.grand total')); ?> (<?php echo e(auth()->user()->currency); ?>)</strong>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><?php echo e(trans('file.Unit Cost')); ?> (<?php echo e(auth()->user()->currency); ?>)</label>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if(flag){
                ...
                cols += '<td class=""><input type="text" class="form-control net_unit_cost" name="net_cost[]" value="'+data[2]+'" step="any"/></td>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/purchase/create.blade.php ENDPATH**/ ?>