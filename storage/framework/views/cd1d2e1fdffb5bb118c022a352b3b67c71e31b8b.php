                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    ...
                                    <?php else: ?>
                                    <button type="button" data-id="<?php echo e($tax->id); ?>" class="btn btn-link" data-toggle="modal" data-target="#changeModal"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?>
...
<?php if(isset($not_permitted)): ?>
<div id="changeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
	<div role="document" class="modal-dialog">
		  <div class="modal-content">
		    <?php echo Form::open(['route' => ['tax.change'], 'method' => 'put']); ?>
		        ...
		        <form>
		            ...
		            <div class="form-group">
		                ...
		                <select name="tax_id" class="form-control">
                            <?php $__currentLoopData = $lims_taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/tax/create.blade.php ENDPATH**/ ?>