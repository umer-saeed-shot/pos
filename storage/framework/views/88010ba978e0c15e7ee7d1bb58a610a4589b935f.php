...
<div style="max-width:400px;margin:0 auto">
    ...
    <div class="hidden-print">
        <table>
            <tr>
                <td><a href="<?php echo e($url); ?>" class="btn btn-info"><i class="fa fa-arrow-left"></i> Close</a> </td>
    ...
    <div id="receipt-data">
        ...
        <p>Date: <?php echo e($lims_sale_data->updated_at->format('Y-m-d')); ?> - <?php echo e($lims_sale_data->updated_at->format('h:i:s a')); ?> <br>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right;vertical-align:bottom"><?php echo e(number_format((float)$product_sale_data->net_unit_price, 2, '.', '')); ?></td>
                </tr>
