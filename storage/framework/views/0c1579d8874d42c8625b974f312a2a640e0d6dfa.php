...
<table style="border-collapse: collapse; width: 100%;">
	...
	<tbody>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px"><?php echo e($order_tax); ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="border: 1px solid #000; padding: 5px">
				<?php if($paid_amount): ?><?php echo e(number_format((float)($paid_amount), 2, '.', '')); ?>
...
<?php
    $message = \App\EmailMessage::where('shop_owner_id',auth()->user()->id)->where('type','sale_details')->first();
?>
<?php if($message !== null): ?>
...
<?php /**PATH C:\xampp\htdocs\POS\resources\views/mail/sale_details.blade.php ENDPATH**/ ?>