        ...
        <table id="gift_card-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Expense')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th><?php echo e(trans('file.Balance')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/gift_card/index.blade.php ENDPATH**/ ?>