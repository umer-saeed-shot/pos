...
<body>
<?php //echo '<pre>'; print_r( $lims_payment_data); exit;?>
    ...
    <div id="receipt-data">
        <div class="centered">
            ...
            <p><?php echo e(trans('file.Address')); ?>: <?php echo e($lims_warehouse_data->address); ?>
                ...
                <br><?php echo e(trans('file.Phone Number')); ?>: <?php echo e($lims_warehouse_data->phone); ?><br>
            </p>
			<h5>Sr No:<?php echo e($lims_product_sale_data[0]->sale_id); ?></h5>
        </div>
        <p><?php echo e(trans('file.Date')); ?>: <?php echo e($lims_sale_data->updated_at); ?><br>
        ...
        <table class="syed">
            <tbody>
						<tr>
							<th colspan="4" class="syedsons" >RE</th>
							<th colspan="3" class="syedsons">LE</th>
						</tr>
						<tr>
							<td class="syedsons">&nbsp;</td>
							<td class="syedsons">SPH</td>
							<td class="syedsons">CYL</td>
							<td class="syedsons">AXIS</td>
							<td class="syedsons">SPH</td>
							<td class="syedsons">CYL</td>
							<td class="syedsons">AXIS</td>
						</tr>
						<tr>
							<td class="syedsons">D.V.</td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_re_sph); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_re_cyl); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_re_axis); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_le_sph); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_le_cyl); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->dv_le_axis); ?></td>
						</tr>
						<tr>
							<td class="syedsons">N.V.</td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_re_sph); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_re_cyl); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_re_axis); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_le_sph); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_le_cyl); ?></td>
							<td class="syedsons"><?php echo e($lims_customer_data->nv_le_axis); ?></td>
						</tr>	
			</tbody>
		</table>	
        <table>
...
<?php /**PATH D:\xampp\htdocs\salepropos\resources\views/sale/invoice.blade.php ENDPATH**/ ?>