                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('Purchasing Price')); ?> (<?php echo e(auth()->user()->currency); ?>) *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('Selling Price')); ?> (<?php echo e(auth()->user()->currency); ?>) *</strong> </label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/product/create.blade.php ENDPATH**/ ?>