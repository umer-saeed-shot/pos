                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Cost')); ?> (<?php echo e(auth()->user()->currency); ?>)*</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Price')); ?> (<?php echo e(auth()->user()->currency); ?>)*</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tax Type</strong> </label>
                                        <select name="tax_type" class="form-control selectpicker">
                                            <option value="1" <?php if($lims_product_data->tax_type == 1 ): ?>
                                                selected
                                            <?php endif; ?> >Price</option>
                                            <option value="0" <?php if($lims_product_data->tax_type == 0 ): ?>
                                                selected
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/product/edit.blade.php ENDPATH**/ ?>