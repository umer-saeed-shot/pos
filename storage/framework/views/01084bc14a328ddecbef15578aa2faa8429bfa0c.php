        ...
        <table id="product-data-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Price')); ?>(<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Last Cost(<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Average Cost(<?php echo e(auth()->user()->currency); ?>)</th>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        if(product[0] == 'combo') {
            ...
            var newBody = $("<tbody>");
            var newRow = $("<tr>");
            newRow.append('<th><?php echo e(trans("file.product")); ?></th><th><?php echo e(trans("file.Quantity")); ?></th><th><?php echo e(trans("file.Price")); ?>(<?php echo e(auth()->user()->currency); ?>)</th>');
                            ...
                            if(product_id.length && confirmDelete()) {
                                $.ajax({
                                    ...
                                    success:function(data){
                                        location.reload();
                                        // dt.rows( '.selected' ).nodes().to$().removeClass( 'selected' );
                                        // $(':checkbox:checked').each(function(i){
                                        //     if(i){
...
$( document ).ready(function(){
    ...
    $('select').selectpicker();
////////////////////////////////////////////////////////////////////
/*var permission = <?php echo json_encode($all_permission, 15, 512) ?>;
var  tablle = $('#product-data-table').DataTable();
if(jQuery.inArray("products-delete", permission) == -1) {
   //$('.buttons-delete').disable();
   tablle.buttons( '.csv' ).disable();
}
*/
///////////////////////////////////////////////////////////////////
</script>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/product/index.blade.php ENDPATH**/ ?>