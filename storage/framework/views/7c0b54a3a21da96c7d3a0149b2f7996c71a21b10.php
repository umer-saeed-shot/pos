        ...
        <table id="sale-table" class="table sale-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Paid')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th><?php echo e(trans('file.Due')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Cash Amount (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Card Amount (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Check Amount (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>E-transfer Amount (<?php echo e(auth()->user()->currency); ?>)</th>
            ...
            <tfoot class="tfoot active">
                <th></th>
                <th><?php echo e(trans('file.Total')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                <th></th>
                <th></th>
                <th></th>
                <th></th>
        ...
        <div class="modal-content">
            ...
            <table class="table table-bordered product-sale-list">
                <thead>
                    ...
                    <th><?php echo e(trans('file.Unit Price')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th><?php echo e(trans('file.Tax')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th><?php echo e(trans('file.Discount')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th><?php echo e(trans('file.Subtotal')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                </thead>
                <tbody>
                </tbody>
            </table>
                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(trans('file.Amount')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                ...
                <?php echo Form::open(['route' => 'sale.add-payment', 'method' => 'post', 'files' => true, 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label><?php echo e(trans('file.Change')); ?> (<?php echo e(auth()->user()->currency); ?>) : </label>
...
<script type="text/javascript">
    ...
    $("#print-btn").on("click", function(){
        ...
        var id = $("#sale-details input[name='sale_id']").val();
        window.location = "<?php echo e(URL::to('/')); ?>/sales/gen_invoice/"+id;
    ...
    function saleDetails(sale,payment_breakdown){
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=4><strong><?php echo e(trans("file.Total")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            cols += '<td>' + sale[14] + '</td>';
            cols += '<td>' + sale[15] + '</td>';
            cols += '<td>' + sale[16] + '</td>';
            newRow.append(cols);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Order Tax")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Order Discount")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            cols += '<td>' + sale[19] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            if(sale[28]) {
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong><?php echo e(trans("file.Coupon Discount")); ?> (<?php echo e(auth()->user()->currency); ?>) ['+sale[28]+']:</strong></td>';
                cols += '<td>' + sale[29] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Shipping Cost")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            cols += '<td>' + sale[20] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.grand total")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            cols += '<td>' + sale[21] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Paid Amount")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            cols += '<td>' + sale[22] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=6><strong><?php echo e(trans("file.Due")); ?> (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=7 style="text-align:center"><strong>Payment Breakdown</strong></td>';
            ...
            if(breakdown[0] !== '0.00'){
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong>Card (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
                cols += '<td>' + breakdown[0] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }else if(breakdown[1] !== '0.00'){

                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong>Cash (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
                cols += '<td>' + breakdown[1] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);


            }else if(breakdown[2] !== '0.00'){
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong>Check (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
                cols += '<td>' + breakdown[2] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }else{
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=6><strong>E-Transfer (<?php echo e(auth()->user()->currency); ?>):</strong></td>';
                cols += '<td>' + breakdown[3] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Sale Note")); ?>:</strong> '+sale[23]+'</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+sale[25]+'<br>'+sale[26];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/sale/index.blade.php ENDPATH**/ ?>