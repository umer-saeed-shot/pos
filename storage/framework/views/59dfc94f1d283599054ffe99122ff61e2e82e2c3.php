            ...
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <button id="unhold-btn" type="button" class="btn btn-default btn-sm"><a href="#"/>Unhold</a></button>
...
<script type="text/javascript">
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(sale_id.length && confirm("Are you sure want to delete?")) {
                            $.ajax({
                                type:'POST',
                                url:'<?php echo e(URL::to("/")); ?>/sales/deletebyselection',
                                data:{
                                    saleIdArray: sale_id
                                },
    ...
    function saleDetails(sale,payment_breakdown){
        ...
        $('#unhold-btn a').attr('href','<?php echo e(URL::to('/')); ?>/unhold_pos/'+sale[13])
