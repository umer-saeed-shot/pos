        ...
        <table id="coupon-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Minimum Amount')); ?> (<?php echo e(auth()->user()->currency); ?>)</th>
                    <th>Qty</th>
                ...
                <?php echo Form::open(['route' => 'coupons.store', 'method' => 'post']); ?>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 form-group minimum-amount">
                          <label><?php echo e(trans('file.Minimum Amount')); ?> (<?php echo e(auth()->user()->currency); ?>) *</label>
                          <input type="number" name="minimum_amount" step="any" class="form-control">
                      </div>
                      <div class="col-md-6 form-group">
                          <label><?php echo e(trans('file.Amount')); ?> (<?php echo e(auth()->user()->currency); ?>) *</label>
                          <div class="input-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\POS\resources\views/coupon/index.blade.php ENDPATH**/ ?>