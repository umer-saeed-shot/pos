            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #cf2029;" type="button" class="btn btn-custom" data-toggle="modal" id="recent-transaction" data-target="#recentTransaction"><i class="dripicons-clock"></i> Held Receipts</button>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <!--<tr data-toggle="modal" data-target="#add-paymentt">-->
												   <tr class='clickable-row' data-href='<?php echo e(url('sales/'.$draft->id.'/create')); ?>'>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\911pos\resources\views/sale/poss.blade.php ENDPATH**/ ?>