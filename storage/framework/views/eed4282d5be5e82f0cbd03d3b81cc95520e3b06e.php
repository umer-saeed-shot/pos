                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">   
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" value="<?php echo e($lims_biller_data->company_name); ?>"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e($lims_biller_data->email); ?>"  class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" value="<?php echo e($lims_biller_data->address); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.City')); ?> </label>
                                    <input type="text" name="city"  value="<?php echo e($lims_biller_data->city); ?>" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/editingteam/public_html/pos/resources/views/biller/edit.blade.php ENDPATH**/ ?>