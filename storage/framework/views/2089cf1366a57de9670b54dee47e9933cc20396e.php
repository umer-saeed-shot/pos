                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title"><?php echo e(trans('file.Tax')); ?> (<?php echo e(auth()->user()->currency); ?>) <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span><span id="tax">0.00</span>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <tbody>
                                                ...
                                                <!--<tr data-toggle="modal" data-target="#add-paymentt">-->
												   ...
												   <tr class='clickable-row'  >
                                                    ...
                                                    <td>
                                                   <div class="btn-group">
                                                    <a onclick="getHeldProduct(<?php echo e($draft->id); ?>)" class="btn btn-success btn-sm" title="Edit" style=" padding: 0px 8px;  margin: 0px 5px; height: 31px;"><i class="dripicons-document-edit"></i></a>
    ...
    function getHeldProduct(sale_id){
        $.get('sales/getheldproduct/' + sale_id, function(data) {
            ...
            if(sale['cash_payment'] !== null){
                ...
                var row = row + '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Cheque (<?php echo e(auth()->user()->currency); ?>)</span><span id="item" class="col-3">'+sale['cheque_payment']+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
...
function addPaymentOptions(amount,pay_id,sale_note,staff_note,payment_note){
    ...
    if(pay_id == 1){
        ...
        var row = '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Cheque (<?php echo e(auth()->user()->currency); ?>)</span><span id="item" class="col-2">'+amount+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
    }else if(pay_id == 7){
