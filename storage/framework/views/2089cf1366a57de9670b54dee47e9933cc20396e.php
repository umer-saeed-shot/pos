            ...
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2"><?php echo e(trans('file.Tax')); ?></th>
                    ...
                    <div class="payment-amount">
                        <h2 id="pa"><?php echo e(trans('file.grand total')); ?> <span id="grand-total">0.00</span></h2>
...
function addMiscItem(){
    ...
    $.ajax({
        ...
        data: {_token:"<?php echo e(csrf_token()); ?>",price:price,qty:qty,discount:discount,tax:tax,total_price:total_price,name:name,cost:cost,category_id:category_id},
