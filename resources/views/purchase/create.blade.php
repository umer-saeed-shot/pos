                            ...
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{trans('file.Net Unit Cost')}}({{ auth()->user()->currency }})</th>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Discount')}} ({{ auth()->user()->currency }})</strong>
                                            </label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label>{{trans('file.Unit Cost')}} ({{ auth()->user()->currency }})</label>
