              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number revenue-data"><i class="fa fa-usd" style="color: #733686"></i>{{number_format((float)$revenue, 2, '.', '')}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number return-data"><i class="fa fa-usd" style="color: #ff8952"></i>{{number_format((float)$return, 2, '.', '')}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number purchase_return-data"><i class="fa fa-usd" style="color: #00c689"></i>{{number_format((float)$purchase_return, 2, '.', '')}}</div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number profit-data"><i class="fa fa-usd" style="color: #297ff9"></i>{{number_format((float)$profit, 2, '.', '')}}</div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-7 mt-4">
              <div class="card line-chart-example">
                <div class="card-header d-flex align-items-center">
                  ...
                  <div class="col-4 float-right">
                    <select name="type" id="cash_flow_type" class="form-control" onchange="cashFlowFilter()">
...
<script>
    ...
    function existingCashFlowGraph(){
