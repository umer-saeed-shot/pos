        ...
        <table id="coupon-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Minimum Amount')}} ({{ auth()->user()->currency }})</th>
                    <th>Qty</th>
                ...
                {!! Form::open(['route' => 'coupons.store', 'method' => 'post']) !!}
                  <div class="row">
                      ...
                      <div class="col-md-6 form-group minimum-amount">
                          <label>{{trans('file.Minimum Amount')}} ({{ auth()->user()->currency }}) *</label>
                          <input type="number" name="minimum_amount" step="any" class="form-control">
                      </div>
                      <div class="col-md-6 form-group">
                          <label>{{trans('file.Amount')}} ({{ auth()->user()->currency }}) *</label>
                          <div class="input-group">
