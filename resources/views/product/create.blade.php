                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('Purchasing Price')}} (<i style="color:#cf2029" class="fa fa-usd" aria-hidden="true"></i>) *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Selling Price')}} (<i style="color:#cf2029" class="fa fa-usd" aria-hidden="true"></i>) *</strong> </label>
