        ...
        <table id="product-data-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{trans('file.Price')}}({{ auth()->user()->currency }})</th>
                    <th>Last Cost({{ auth()->user()->currency }})</th>
                    <th>Average Cost({{ auth()->user()->currency }})</th>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        if(product[0] == 'combo') {
            ...
            var newBody = $("<tbody>");
            var newRow = $("<tr>");
            newRow.append('<th>{{trans("file.product")}}</th><th>{{trans("file.Quantity")}}</th><th>{{trans("file.Price")}}({{ auth()->user()->currency }})</th>');
...
$( document ).ready(function(){
    ...
    $('select').selectpicker();
////////////////////////////////////////////////////////////////////
/*var permission = @json($all_permission);
