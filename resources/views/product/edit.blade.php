                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Product Cost')}} ({{ auth()->user()->currency }})*</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Product Price')}} ({{ auth()->user()->currency }})*</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="tax_type" class="form-control selectpicker">
                                            <option value="1" @if ($lims_product_data->tax_type == 1 )
                                                selected
                                            @endif >Price</option>
                                            <option value="0" @if ($lims_product_data->tax_type == 0 )
                                                selected
                                            @endif >Cost</option>
                                        </select>
                                    </div>
