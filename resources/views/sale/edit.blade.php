...
<section class="forms">
                            ...
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{trans('file.Net Unit Price')}} ({{ auth()->user()->currency }})</th>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Order Discount')}} ({{ auth()->user()->currency }})</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Shipping Cost')}} ({{ auth()->user()->currency }})</strong>
                                            </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{trans('file.Coupon Discount')}} ({{ auth()->user()->currency }})</strong>
                                            </label>
    ...
    <div class="container-fluid">
        <table class="table table-bordered table-condensed totals">
            ...
            <td><strong>{{trans('file.Total')}} ({{ auth()->user()->currency }})</strong>
                <span class="pull-right" id="subtotal">0.00</span>
            </td>
            <td><strong>{{trans('file.Order Tax')}} ({{ auth()->user()->currency }})</strong>
                <span class="pull-right" id="order_tax">0.00</span>
            </td>
            <td><strong>{{trans('file.Order Discount')}} ({{ auth()->user()->currency }})</strong>
                <span class="pull-right" id="order_discount">0.00</span>
            </td>
            <td><strong>{{trans('file.Shipping Cost')}} ({{ auth()->user()->currency }})</strong>
                <span class="pull-right" id="shipping_cost">0.00</span>
            </td>
            <td><strong>{{trans('file.grand total')}} ({{ auth()->user()->currency }})</strong>
