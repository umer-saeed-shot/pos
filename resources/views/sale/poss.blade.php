                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="cost" id="misc_cost" class="form-control" step="0.01" placeholder="Cost ({{ auth()->user()->currency }})" >
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-2">
                                    <input type="text" name="price" id="misc_price" class="form-control" step="0.01" placeholder="Price ({{ auth()->user()->currency }})" >
                                </div>
                                x
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <input type="text" name="misc_discount" id="misc_discount" class="form-control" step="0.01" placeholder="Discount ({{ auth()->user()->currency }})" >
                                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos">
                                                ...
                                                <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true"  title="Select customer/phone number" style="width: 100px">
                                                    ...
                                                    <option value="{{$customer->id}}" @if(isset($cust_id)) @if($cust_id == $customer->id) selected @endif  @endif>{{ $customer->name .' ( '. $customer->phone_number.' )'  }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2">{{trans('file.Tax')}} ({{ auth()->user()->currency }})</th>
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Total')}} ({{ auth()->user()->currency }})</span><span id="subtotal">0.00</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Tax')}} ({{ auth()->user()->currency }}) </span><span id="tax">0.00</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Discount')}} ({{ auth()->user()->currency }}) <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-discount"> <i class="dripicons-document-edit"></i></button></span><span id="discount">0.00</span>
                                        </div>
                                        <div class="col-sm-4">
                                            <span class="totals-title">{{trans('file.Coupon')}} ({{ auth()->user()->currency }}) <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#coupon-modal"><i class="dripicons-document-edit"></i></button></span><span id="coupon-text">0.00</span>
                                        </div>

                                        <div class="col-sm-4" style="display: none">
                                            <span class="totals-title">{{trans('file.Shipping')}} ({{ auth()->user()->currency }}) <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#shipping-cost-modal"><i class="dripicons-document-edit"></i></button></span><span id="shipping-cost">0.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-amount">
                        <h2 id="pa">{{trans('file.grand total')}} ({{ auth()->user()->currency }}) <span id="grand-total">0.00</span></h2>
                        <h2 id="da" style="display: none">Due ({{ auth()->user()->currency }}) :  <span id="due-total">0.00</span></h2>
                    </div>
				...
				<div id="add-paymentt" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
					<div role="document" class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
							{!! Form::open(['route' => 'sale.add-paymentt', 'method' => 'post', 'files' => true, 'id'=>'draptSub', 'class' => 'paymentt-form' ]) !!}
									<div class="row">
									...
									<input type="submit" class="btn paysubmit btn-primary" value="{{trans('file.submit')}}">
                                        ...
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{trans('file.grand total')}} ({{ auth()->user()->currency }})</th>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <!--<tr data-toggle="modal" data-target="#add-paymentt">-->
												   <!--<tr class='clickable-row' data-href='{{url('sales/'.$draft->id.'/create') }}'>data-href='{{url('sales/'.$draft->id.'/edit') }}'-->
												   <tr class='clickable-row'  >
                                                    <td onclick="getHeldProduct({{ $draft->id }},{{$draft->customer_id}})">{{date('d-m-Y', strtotime($draft->created_at))}}</td>
                                                    <td onclick="getHeldProduct({{ $draft->id }},{{$draft->customer_id}})">{{$draft->reference_no}}</td>
                                                    <td onclick="getHeldProduct({{ $draft->id }},{{$draft->customer_id}})">{{$customer->name}}</td>
                                                    <td onclick="getHeldProduct({{ $draft->id }},{{$draft->customer_id}})">{{$draft->grand_total}}</td>
                                                    <td>
                                                   <div class="btn-group">
                                                    <a onclick="getHeldProduct({{ $draft->id }},{{$draft->customer_id}})" class="btn btn-success btn-sm" title="Edit" style=" padding: 0px 8px;  margin: 0px 5px; height: 31px;"><i class="dripicons-document-edit"></i></a>
                                                    <a href="{{ URL::to('/') }}/sales/gen_invoice/{{ $draft->id }}" class="btn btn-success btn-sm" title="Print" style=" padding: 0px 8px;  margin: 0px 5px; height: 31px;"><i class="dripicons-print"></i></a>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>{{trans('file.Cash in Hand')}} ({{ auth()->user()->currency }}) *</strong> </label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td>{{trans('file.Cash in Hand')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="cash_in_hand" class="text-right">0</td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Total Sale Amount')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="total_sale_amount" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Total Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="total_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Cash Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="cash_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Credit Card Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="credit_card_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Cheque Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="cheque_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Gift Card Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="gift_card_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Paypal Payment')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="paypal_payment" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Total Sale Return')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="total_sale_return" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Total Expense')}} ({{ auth()->user()->currency }}):</td>
                                                <td id="total_expense" class="text-right"></td>
                                            </tr>
                                            <tr>
                                                <td><strong>{{trans('file.Total Cash')}} ({{ auth()->user()->currency }}):</strong></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-2">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                <td>{{trans('file.Product Revenue')}} ({{ auth()->user()->currency }}):</td>
                                                <td class="product_revenue text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Product Cost')}} ({{ auth()->user()->currency }}):</td>
                                                <td class="product_cost text-right"></td>
                                            </tr>
                                            <tr>
                                                <td>{{trans('file.Expense')}} ({{ auth()->user()->currency }}):</td>
                                                <td class="expense_amount text-right"></td>
                                            </tr>
                                            <tr>
                                                <td><strong>{{trans('file.Profit')}} ({{ auth()->user()->currency }}):</strong></td>
...
function addMiscItem(){
    ...
    $.ajax({
        ...
        data: {_token:"{{ csrf_token() }}",price:price,qty:qty,discount:discount,tax:tax,total_price:total_price,name:name,cost:cost,category_id:category_id,tax_type : tax_type},
...
<script type="text/javascript">
    ...
    @if(Session::has('cust_id'))
    	$('select[name=customer_id]').val({{Session::get('cust_id')}});
    @endif

    @if (Session::has('draft_id'))
	$('select[name=customer_id]').val({{Session::get('customer_id')}});
	$.get('sales/getcustomergroup/' + {{Session::get('customer_id')}}, function(data) {
		customer_group_rate = (data / 100);
	    });
    	getHeldProduct({{ Session::get('draft_id') }});
    @php
    ...
    function getHeldProduct(sale_id,customer_id = null){
        ...
        $.get('sales/getheldproduct/' + sale_id, function(data) {
            ...
            if(sale['cash_payment'] !== null){
                var row = row + '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Cash ({{ auth()->user()->currency }})</span><span id="item" class="col-3">'+sale['cash_payment']+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due btn btn-danger btn-sm col-2"><i class="dripicons-cross"></i></button></div>'
                ...
                var row = row + '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Card ({{ auth()->user()->currency }})</span><span id="item" class="col-3">'+sale['card_payment']+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
                ...
                var row = row + '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Check ({{ auth()->user()->currency }})</span><span id="item" class="col-3">'+sale['cheque_payment']+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
    ...
    function cancel(rownumber) {
        ...
        if(miscProductsID.length > 0){
            $.ajax({
                ...
                data: {_token:"{{ csrf_token() }}",ids : miscProductsID},
                dataType: "JSON",
                success: function (response) {
                    if(response == 1){
                        calculateTotal();
...
function addPaymentOptions(amount,pay_id,sale_note,staff_note,payment_note){
    ...
    $('#payment-options').css('display','block');
    if(pay_id == 1){
        var row = '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Cash ({{ auth()->user()->currency }})</span><span id="item" class="col-2">'+amount+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due btn btn-danger btn-sm col-2"><i class="dripicons-cross"></i></button></div>'
    }else if(pay_id == 3){
        var row = '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Card ({{ auth()->user()->currency }})</span><span id="item" class="col-2">'+amount+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
    }else if(pay_id == 4){
        var row = '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">Check ({{ auth()->user()->currency }})</span><span id="item" class="col-2">'+amount+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="remove-due col-2 btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
    }else if(pay_id == 7){
        var row = '<div class="col-sm-4 offset-8" id="'+uid+'"><span class="totals-title">E-Transfer ({{ auth()->user()->currency }})</span><span id="item" class="col-2">'+amount+'</span><button type="button" style="margin-left:2%" onclick="removeDue(this)" class="col-2 remove-due btn btn-danger btn-sm"><i class="dripicons-cross"></i></button></div>'
    }
