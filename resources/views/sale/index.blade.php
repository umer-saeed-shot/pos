        ...
        <table id="sale-table" class="table sale-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>Cheque Amount ({{ auth()->user()->currency }})</th>
...
<script type="text/javascript">
    ...
    function saleDetails(sale,payment_breakdown){
        ...
        if(breakdown[0] !== '0.00'){
            htmltext += '<div class="col-md-6"><strong>Card ({{ auth()->user()->currency }}): </strong>'+breakdown[0]+'</div>';
        }else if(breakdown[1] !== '0.00'){
            htmltext += '<div class="col-md-6"><strong>Cash ({{ auth()->user()->currency }}): </strong>'+breakdown[1]+'</div>';
        }else if(breakdown[2] !== '0.00'){
            htmltext += '<div class="col-md-6"><strong>Cheque ({{ auth()->user()->currency }}): </strong>'+breakdown[2]+'</div>';
        }else{
            htmltext += '<div class="col-md-6"><strong>E-Transfer ({{ auth()->user()->currency }}): </strong>'+breakdown[3]+'</div>';
        }
        htmltext += '</div>';
